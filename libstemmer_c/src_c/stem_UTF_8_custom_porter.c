...
extern "C" {
#endif
extern int custom_porter_UTF_8_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
extern struct SN_env * custom_porter_UTF_8_create_env(void);
extern void custom_porter_UTF_8_close_env(struct SN_env * z);
...
extern struct SN_env * custom_porter_UTF_8_create_env(void) { return SN_create_env(0, 2, 1); }

extern void custom_porter_UTF_8_close_env(struct SN_env * z) { SN_close_env(z, 0); }
